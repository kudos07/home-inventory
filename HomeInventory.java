...
edited = true;
else if (!myInventory[currentEntry -l].location.equals(locationComboBox.getSelectedItem().toStrin g()))
edited = true;
...
if (edited)
{
if (JOptionPane.showConfirmDialog(null, "You have edited this item. Do you want tosave the changes?", "Save Item", JOptionPane.YES_NO_OPTION,
